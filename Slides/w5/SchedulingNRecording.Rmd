...
- Let's try it. [level_of_processing.py](https://github.com/hy-lin/PsychoPy2018/blob/master/Codes/Week5_SchedulingNRecording/level_of_processing1.py)
...
```{python}
    ...
    response != 'o'
    not response == 'o'
    response == 'o' and response_time < 0.5
